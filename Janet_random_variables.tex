...
\textbf{Standard Deviation}: $\sigma$.  Square root of variance. 
...
The variance refers to the spread of the data set Ñ how far apart the numbers are in relation to the mean, for instance.
